const OddLabel: React.FC<{
    oddsLabelName: string;
    OddsLabelValue: string;
    marketIsBlocked: boolean;
}> = ({ oddsLabelName, OddsLabelValue, marketIsBlocked }) => {
    return (
        <div className="flex flex-col items-center justify-center bg-transparent border-none cursor-pointer rounded-[var(--radius-xs)] max-h-[56px] py-2 px-4 w-full">
