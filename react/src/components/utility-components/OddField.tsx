...
const OddField: React.FC<{
  ...
  return (
    <div
      ...
      } h-full max-h-[56px] min-h-[40px] w-full min-w-[34px] cursor-pointer items-center justify-center rounded-[var(--radius-xs)] px-4 py-2 duration-100 hover:bg-[var(--control-secondary-hover)]`}
    >
      <div
