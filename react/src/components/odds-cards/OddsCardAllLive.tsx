    ...
    return (
        <div className="flex flex-nowrap flex-row w-full gap-2">
            {marketType === 3 && market1Name && market2Name && market3Name && (
                <>
                    <OddField marketName={market1Name} marketPrice={display1Price} marketIsBlocked={marketIsBlocked} />
                    <OddField marketName={market2Name} marketPrice={display2Price} marketIsBlocked={marketIsBlocked} />
                    <OddField marketName={market3Name} marketPrice={display3Price} marketIsBlocked={marketIsBlocked} />
                </>
            )}
            ...
            {marketType === 2 && marketShowLabel === true && marketName && marketValue && (
                <>
                    <OddField marketName={market1Name} marketPrice={display1Price} marketIsBlocked={marketIsBlocked} />
                    <OddLabel oddsLabelName={marketName} OddsLabelValue={marketValue} marketIsBlocked={marketIsBlocked} />
                    <OddField marketName={market2Name} marketPrice={display2Price} marketIsBlocked={marketIsBlocked} />
                </>
            )}
        </div>
