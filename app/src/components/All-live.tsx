...
function getCountryCode(countryName: string) {
    ...
    return country ? country.alpha3.toLowerCase() : "N/A"; // Если страна найдена, возвращаем её трёхбуквенный код, если нет — 'N/A'
}
...
const AllLive: React.FC = () => {
    ...
    useEffect(() => {
        fetchData();
        const intervalId = setInterval(fetchData, 10000); // Повторяем запрос каждые 10 секунд

        return () => clearInterval(intervalId); // Загружаем данные при монтировании компонента
    }, []);
                ...
                return (
                    ...
                    >
                        <div className="flex w-full flex-col">
                            <div className="flex w-full px-4 h-10">
                            ...
                            <div className="flex w-full flex-col">
                                <div className="flex flex-row w-full border-t-[var(--divider-main)] border-t px-4 gap-2">
                                        ...
                                        <div className="flex w-full flex-col">
                                            ...
                                            <div className="flex w-full gap-2">
                                                ...
                                                <div className="flex flex-1 gap-2">
                                                    <div className="flex flex-col bg-[var(--control-secondary)] rounded-[var(--radius-xs)] w-full h-full items-center justify-center">
